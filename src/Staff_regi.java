...
public class Staff_regi extends JDialog {
	...
	public Staff_regi() {
		...
		}
		{
			...
			{
				JLabel lblEID = new JLabel("Position :");
			...
			{
				JComboBox comboBox_2 = new JComboBox();
				comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"Select Position", "Account Manager", "Branch Manager", "Regional Manager", "Operations Manager"}));
				comboBox_2.setBounds(125, 211, 243, 21);
				panel.add(comboBox_2);
			}
		}
		{
